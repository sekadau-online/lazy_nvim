...
echo "===================================================="
echo " ⚙️  Neovim Full-Dev Setup (Laravel, Rust, JS, Tailwind) - Termux"
echo "===================================================="
sleep 1
...
mkdir -p "$NVIM_DIR/lua/core" "$NVIM_DIR/lua/plugins" "$DATA_DIR"
...
echo "Jalankan Neovim:"
echo "    nvim"
echo "Plugin akan otomatis diinstal oleh Lazy.nvim."
echo "===================================================="